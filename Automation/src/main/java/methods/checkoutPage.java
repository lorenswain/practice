...
public class checkoutPage {
	...
	//------------------------------------------------------------------------------------------------------------------------	
	   ...
	   public	void BelowFst_rush_option_RadioBTN() 
	    ...
	    By Increase_quantity_checkout = By.xpath("//span[@data-a-selector=\"increment-icon\"]");
	    public	void Increase_quantity_checkout(int x) throws InterruptedException 
	  		{
	    	    for(int i =1;i<x;x--) {
	  			driver.findElement(Increase_quantity_checkout).click();     
	  			Thread.sleep(4000);
	  			}
	  		}
}
