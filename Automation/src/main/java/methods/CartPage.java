...
public class CartPage {
	...
	public void increase_quantity_cartpage(int i) throws InterruptedException
	{ driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
		for (int c=1;c<i ;c++) {
	...
	public void decrease_quantity_cartpage() throws InterruptedException
	{  driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
	...
	public void delete_by_decrease_quantity_cartpage() throws InterruptedException
	{   
		driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
		String x = driver.findElement(quantity_check).getText();
		int z = Integer.parseInt(x);
